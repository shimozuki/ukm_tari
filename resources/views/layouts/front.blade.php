...
<head>
    ...
    <title>UKM Tari UTS</title>
    <link rel="icon" href="{{ asset('frontemplate') }}/img/icon.png">
    <!-- Bootstrap CSS -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> UKM Tari UTS </a>
            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="single-footer-widget footer_1">
                        ...
                        <p>Platform UKM Tari Universitas Teknologi Sumbawa</p>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-sm-6 col-md-4">
                    <div class="single-footer-widget footer_2">
                        ...
                        <div class="contact_info">
                            <p><span> Address :</span> Jl. Raya Olat Maras Batu Alang, Pernek, Kec. Moyo Hulu, Kabupaten Sumbawa, Nusa Tenggara Bar. 84371 </p>
                            <p><span> Phone :</span> (0371) 2629009</p>
                            <p><span> Email : </span>uts_tari@gmail.com </p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12">
                                <p class="footer-text m-0">
                                    ...
                                    Copyright &copy;<script>
                                        ...
                                        href="https:://github/shimozuki">mahasiswa uts</a>
                                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                </p>
                            </div>
                        </div>
